...
func RunTests(ctx context.Context, client gwclient.Client, spec *dalec.Spec, withTestDeps llb.StateOption, target string, opts ...llb.ConstraintsOpt) llb.StateOption {
	return func(in llb.State) llb.State {
		...
		runTests := testrunner.WithTests(target, frontendSt, withTestDeps, tests, opts...)
