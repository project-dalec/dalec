...
func TestGitSourceWebURL(t *testing.T) {
	for _, tc := range []struct {
		...
		{"integer loopback", "http://2130706433/repo.git", ""},
		{"hexadecimal loopback", "http://0x7f000001/repo.git", ""},
		{"uppercase hexadecimal loopback", "http://0X7F000001/repo.git", ""},
		{"octal loopback", "http://0177.0.0.1/repo.git", ""},
		{"integer octal loopback", "http://017700000001/repo.git", ""},
		{"mixed radix loopback", "http://0x7f.00.0.01/repo.git", ""},
		{"empty hexadecimal zero components", "http://0x7f.0x.0x.1/repo.git", ""},
		{"zero padded loopback", "http://127.000.000.001/repo.git", ""},
		{"qualified abbreviated loopback with port", "https://127.1.:8443/repo.git", ""},
		{"private IP", "http://10.0.0.1/repo.git", ""},
		{"abbreviated private IP", "http://10.1/repo.git", ""},
		{"integer private IP", "http://167772161/repo.git", ""},
		{"hexadecimal private IP", "http://0xc0a80101/repo.git", ""},
		{"abbreviated link local", "http://169.254.1/repo.git", ""},
		{"integer unspecified IP", "http://0/repo.git", ""},
		{"noncanonical public IPv4", "http://0xc0000201/repo.git", ""},
		{"overflowing numeric host", "http://999999999999999999999999/repo.git", ""},
